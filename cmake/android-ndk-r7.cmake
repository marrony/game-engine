...
if ("${ANDROID_NDK_STL}" STREQUAL "stlport") 
	...
	set(ANDROID_NDK_STL_CXXFLAGS "-I${ANDROID_NDK_ROOT}/sources/cxx-stl/${ANDROID_NDK_STL}/${ANDROID_NDK_GCC_VERSION}/include -I${ANDROID_NDK_ROOT}/sources/cxx-stl/${ANDROID_NDK_STL}/${ANDROID_NDK_GCC_VERSION}/libs/${ANDROID_NDK_ABI}/include  -fno-exceptions -fno-rtti ")
...
set(ANDROID_NDK_PATH ${ANDROID_NDK_ROOT}/toolchains/${ANDROID_NDK_ABI_EXT}-${ANDROID_NDK_GCC_VERSION}/prebuilt/${ANDROID_NDK_HOST})
...
exec_program(
	${ANDROID_NDK_PATH}/bin/${ANDROID_NDK_GCC_PREFIX}-gcc 
...
# # specify compiler
#set(CMAKE_C_COMPILER   "${ANDROID_NDK_PATH}/bin/${ANDROID_NDK_GCC_PREFIX}-gcc" CACHE PATH "C compiler" FORCE)
#set(CMAKE_CXX_COMPILER "${ANDROID_NDK_PATH}/bin/${ANDROID_NDK_GCC_PREFIX}-g++" CACHE PATH "C++ compiler" FORCE)

# specify the cross compiler
CMAKE_FORCE_C_COMPILER("${ANDROID_NDK_PATH}/bin/${ANDROID_NDK_GCC_PREFIX}-gcc" GNU)
CMAKE_FORCE_CXX_COMPILER("${ANDROID_NDK_PATH}/bin/${ANDROID_NDK_GCC_PREFIX}-g++" GNU)

message(STATUS "ANDROID_NDK_PATH = ${ANDROID_NDK_PATH}")
